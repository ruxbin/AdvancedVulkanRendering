...
struct fmt::formatter<vec4> : fmt::formatter<std::string>
{
    ...
    {
        return fmt::v9::format_to(ctx.out(), "[vec4 ={} {} {} {}]", my.x, my.y, my.z,my.w);
    }
};
...
struct fmt::formatter<vec3> : fmt::formatter<std::string>
{
    ...
    {
        return fmt::v9::format_to(ctx.out(), "[vec3 ={} {} {}]", my.x, my.y, my.z);
    }
};
...
struct fmt::formatter<vec2> : fmt::formatter<std::string>
{
    ...
    {
        return fmt::v9::format_to(ctx.out(), "[vec2 ={} {}]", my.x, my.y);
    }
};
