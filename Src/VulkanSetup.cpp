...
VulkanDevice::VulkanDevice(SDL_Window* sdl_window)
{
    ...
    VkApplicationInfo appInfo{};
        ...
        createInfo.ppEnabledExtensionNames = instaceExtensionNames;//(const char* const *)extensions.data();
        ...
        //create surface
        if (vkCreateWin32SurfaceKHR(vkInstance, &win32surfaceCreateInfo, nullptr, &win32Surface) != VK_SUCCESS)
        {
...
{     
    ...
    std::vector<std::string_view> extensions = {"VK_KHR_surface","VK_KHR_win32_surface"};
    ...
    void VulkanDevice::createLogicalDevice() {
        ...
        createInfo.enabledExtensionCount = static_cast<uint32_t>(sizeof(deviceExtensionNames)/sizeof(deviceExtensionNames[0]));
